...
INSERT INTO pet_status(id,name) VALUES (1, 'SICK');
INSERT INTO pet_status(id,name) VALUES (2, 'HEALTHY');

INSERT INTO hospitalisation_status(id,name) VALUES (1, 'HOSPITALISED');
INSERT INTO hospitalisation_status(id,name) VALUES (2, 'DISCHARGED');
...
INSERT INTO pets(id,name,birth_date,type_id,owner_id,pet_status_id) VALUES (1, 'Leo', '2010-09-07', 1, 1, 1);
INSERT INTO pets(id,name,birth_date,type_id,owner_id,pet_status_id) VALUES (2, 'Basil', '2012-08-06', 6, 2, 2);
INSERT INTO pets(id,name,birth_date,type_id,owner_id,pet_status_id) VALUES (3, 'Rosy', '2011-04-17', 2, 3, 2);
INSERT INTO pets(id,name,birth_date,type_id,owner_id,pet_status_id) VALUES (4, 'Jewel', '2010-03-07', 2, 3, 2);
INSERT INTO pets(id,name,birth_date,type_id,owner_id,pet_status_id) VALUES (5, 'Iggy', '2010-11-30', 3, 4, 2);
INSERT INTO pets(id,name,birth_date,type_id,owner_id,pet_status_id) VALUES (6, 'George', '2010-01-20', 4, 5, 2);
INSERT INTO pets(id,name,birth_date,type_id,owner_id,pet_status_id) VALUES (7, 'Samantha', '2012-09-04', 1, 6, 1);
INSERT INTO pets(id,name,birth_date,type_id,owner_id,pet_status_id) VALUES (8, 'Max', '2012-09-04', 1, 6, 2);
INSERT INTO pets(id,name,birth_date,type_id,owner_id,pet_status_id) VALUES (9, 'Lucky', '2011-08-06', 5, 7, 2);
INSERT INTO pets(id,name,birth_date,type_id,owner_id,pet_status_id) VALUES (10, 'Mulligan', '2007-02-24', 2, 8, 2);
INSERT INTO pets(id,name,birth_date,type_id,owner_id,pet_status_id) VALUES (11, 'Freddy', '2010-03-09', 5, 9, 2);
INSERT INTO pets(id,name,birth_date,type_id,owner_id,pet_status_id) VALUES (12, 'Lucky', '2010-06-24', 2, 10, 2);
INSERT INTO pets(id,name,birth_date,type_id,owner_id,pet_status_id) VALUES (13, 'Sly', '2012-06-08', 1, 10, 2);
...
INSERT INTO stays(id,price,start_date,finish_date,special_cares,pet_id) VALUES (3, 30.0, '2020-07-01', '2021-07-01','special',7);
INSERT INTO stays(id,price,start_date,finish_date,special_cares,pet_id) VALUES (4, 30.0, '2020-03-01', '2020-06-25','special',7);
...
INSERT INTO stays(id,price,start_date,finish_date,special_cares,pet_id) VALUES (8, 30.0, '2020-02-02', '2020-11-05','special',13);

INSERT INTO hospitalisations(id,start_date,finish_date,treatment,diagnosis,total_price,pet_id,hospitalisation_status) VALUES (1, '2020-02-12', '2020-02-20','treatment1','diagnosis1',30,1,2);
INSERT INTO hospitalisations(id,start_date,finish_date,treatment,diagnosis,total_price,pet_id,hospitalisation_status) VALUES (2, '2020-04-15', '2020-04-19','treatment2','diagnosis2',50,7,2);
INSERT INTO hospitalisations(id,start_date,finish_date,treatment,diagnosis,total_price,pet_id,hospitalisation_status) VALUES (3, '2020-03-28', null, 'treatment3','diagnosis3',70,7,1);
INSERT INTO hospitalisations(id,start_date,finish_date,treatment,diagnosis,total_price,pet_id,hospitalisation_status) VALUES (4, '2020-03-28', null, 'treatment4','diagnosis4',50,1,1);
...
INSERT INTO products(id,name,price,stock,shop_id,discount_id) VALUES (5, 'product5', 15, 10,1,3);
INSERT INTO products(id,name,price,stock,shop_id,discount_id) VALUES (6, 'product6', 15, 10,1,null);

INSERT INTO orders(id,name,supplier,product_number,order_date,order_status,shop_id,product_id) VALUES (1, 'order1', 'supplier1', 10, CURRENT_TIMESTAMP, 0, 1, 2);
...
INSERT INTO orders(id,name,supplier,product_number,order_date,order_status,shop_id,product_id) VALUES (4, 'order4', 'supplier4', 25, '2020-03-20 13:30', 0, 1, 4);
