 ...
 */
@Component
public class HospitalisationStatusFormatter implements Formatter<HospitalisationStatus> {

	private final PetService peService;

	@Autowired
	public HospitalisationStatusFormatter(PetService petService) {
		this.peService = petService;
	}

	@Override
	public String print(HospitalisationStatus hospitalisationStatus, Locale locale) {
		return hospitalisationStatus.getName();
	}
